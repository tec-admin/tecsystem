...
class Class_Model_MTimetables extends BaseMModels
{
	/**
	 * @var string 対応テーブル名
	 */
	const TABLE_NAME = 'm_timetables';
	protected $_name   = Class_Model_MTimetables::TABLE_NAME;

	public static function fieldArray($prefix = '')
	{
		if ($prefix == '')
			$prefix = Class_Model_MTimetables::TABLE_NAME;
