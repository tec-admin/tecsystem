...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		panelElm.setAttribute('class','nic');
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			s[(ie7s) ? 'height' : 'maxHeight'] = (this.ne.options.maxHeight) ? this.ne.options.maxHeight+'px' : null;
			this.editorContain = new bkElement('DIV').setStyle(s).addClass('nic').appendBefore(e);
...
var nicEditorIFrameInstance = nicEditorInstance.extend({
	...
	initFrame : function() {
		...
		fd.write('<html><head>'+((css) ? '<link href="'+css+'" rel="stylesheet" type="text/css" />' : '')+'</head><body id="nicEditContent" style="padding:7px 5px 3px 7px; margin: 0 !important; background-color: transparent !important;">'+initialContent+'</body></html>');
		fd.close();
		this.frameDoc = fd;
